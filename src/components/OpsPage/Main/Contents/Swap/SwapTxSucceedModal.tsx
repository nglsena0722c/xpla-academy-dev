...
export default function SwapTxSucceedModal({
  ...
  return (
    <>
      <img
        src="/xpla-academy-dev/img/opspage/Login/successEmoji.svg"
        alt="successEmoji"
        width="34px"
        height="34px"
      />
        ...
        <div className="flex flex-col items-center justify-between gap-[12px]">
          <div className="flex items-center w-full justify-between">
            {tkn2xpla ? (
              ...
              <img
                className="w-[28px]"
                src="/xpla-academy-dev/img/opspage/Main/stroke-xpla.svg"
                alt="xplaToken"
              />
            )}
          ...
          <img
            ...
            src="/xpla-academy-dev/img/opspage/Main/txsucceedarrow.svg"
            alt="txsucceedarrow"
          />
          <div className="flex items-center w-full justify-between">
            {tkn2xpla ? (
