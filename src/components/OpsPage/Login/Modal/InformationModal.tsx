      ...
      <div className="w-full h-[124px] bg-[#F5F4F4] flex items-center justify-between px-[35px]">
        <div className="flex items-center gap-[15px] py-[26px] text-[18px] leading-[21px]">
          <img
            ...
            src="/xpla-academy-dev/img/opspage/Main/arrowleft.svg"
  ...
  switch (page) {
    case 2:
      return (
        <div className="flex flex-1 flex-col gap-[37px] items-center justify-center">
          <img
            src="/xpla-academy-dev/img/opspage/Main/Info/info-2-img.svg"
            alt="info-2"
            width="366px"
            height="97px"
          />
        ...
        <div className="flex flex-1 flex-col gap-[37px] items-center justify-center w-full">
          ...
          <div className="grid grid-rows-4 gap-[26px] w-full px-[35px]">
            <div className="flex items-center gap-[12px] h-[32px]">
              <img
                src="/xpla-academy-dev/img/opspage/Main/Convert/converttitle.svg"
                alt="converttitle"
                height="28px"
                width="155px"
                className="h-[28px]"
            ...
            <div className="flex items-center gap-[12px] h-[32px]">
              <img
                src="/xpla-academy-dev/img/opspage/Main/Swap/swaptitle.svg"
                alt="swaptitle"
                height="28px"
                width="99px"
                className="h-[28px]"
            ...
            <div className="flex items-center gap-[12px] h-[32px]">
              <img
                src="/xpla-academy-dev/img/opspage/Main/Nftshop/nftshoptitle.svg"
                alt="nftshoptitle"
                height="28px"
                width="154px"
                className="h-[28px]"
            ...
            <div className="flex items-center gap-[12px] h-[32px]">
              <img
                src="/xpla-academy-dev/img/opspage/Main/Leaderboard/leaderboardtitle.svg"
    ...
    default:
      return (
        <div className="flex flex-1 flex-col gap-[37px] items-center justify-center">
          <img
            src="/xpla-academy-dev/img/opspage/Main/Info/info-1-img.svg"
            alt="info-1"
            width="80px"
            height="97px"
          />
