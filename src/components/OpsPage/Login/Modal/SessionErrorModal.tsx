  ...
  return (
    ...
    >
      <img
        ...
        src={`/xpla-academy-dev/img/opspage/Login/failEmoji.svg`}
        alt="failEmoji"
        width="34px"
        height="34px"
      />
      ...
      <div className="relative flex justify-center items-center leading-[25px]">
        <Picture
          sources={[
            `/xpla-academy-dev/img/opspage/Login/sessionErrorBg.webp`,
            `/xpla-academy-dev/img/opspage/Login/sessionErrorBg.svg`,
          ]}
          alt="SessionErrorBg"
          width="399px"
          height="255px"
        ...
        <img className="absolute top-[67px]" width="280px" height="44px" alt="xplaVaultTitle" src={`/xpla-academy-dev/img/opspage/Login/xplaVaultTitle.svg`} />
