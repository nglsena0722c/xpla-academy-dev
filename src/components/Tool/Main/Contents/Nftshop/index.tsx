  ...
  return (
    <>
      <div className="flex flex-col items-center pt-[77px] pb-[79px] bg-[#EAF8FF] h-full">
        <img src="/xpla-academy-dev/img/tool/Main/Nftshop/nftshoptitle.svg" alt="nftshoptitle" width="330px" height="60px" />
        <img
          className="mt-[15px] mb-[4px]"
          src="/xpla-academy-dev/img/tool/Main/starlight.svg"
          alt="starlight"
          width="28px"
          height="28px"
        />
