  ...
  return (
    ...
    >
      <img
        ...
        src={`/xpla-academy-dev/img/tool/Login/failEmoji.svg`}
        alt="failEmoji"
        width="34px"
        height="34px"
      />
      ...
      <div className="relative flex justify-center items-center leading-[25px]">
        ...
        <img className="absolute top-[67px]" width="280px" height="44px" alt="xplaVaultTitle" src={`/xpla-academy-dev/img/tool/Login/xplaVaultTitle.svg`} />
