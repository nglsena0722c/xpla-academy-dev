...
export default function Cocosgame() {
  if (isMobile) {
    return <img src="/xpla-academy-dev/img/PlayGame/comingsoon.svg" />;
  }
  ...
  const iframe =
    '<iframe src="/xpla-academy-dev/img/web-desktop/index.html" width="100%" height="100%" scrolling ="no" ></iframe>';
  return (
    <div
      className={clsx("z-10", {
