  ...
  return (
    ...
    >
      <div className="relative w-full max-w-[1180px] flex justify-start items-start z-10">
        <div className="flex flex-col gap-[64px] text-white text-[26px] leading-[36px] font-normal">
          <img
            width="609px"
            height="61px"
            src="/xpla-academy-dev/img/PlayGamePage/starthere-title.svg"
            alt="starthere-title"
          />
          <div>
        ...
        {isDesktop && (
          <img
            width="586px"
            height="492px"
            src="/xpla-academy-dev/img/PlayGamePage/starthere-img.svg"
            alt="starthere-img"
      ...
      <img
        ...
        src={`/xpla-academy-dev/img/opspage/Login/floor.svg`}
        alt="LoginPageFloor"
        width="2748px"
        height="402px"
      />
