...
xplad로 다양한 일들을 할 수 있습니다. XPLA 블록체인에 query를 보내서 결과를 가져올 수도 있고, 트랜잭션 생성도 가능합니다. 또, [풀노드(Full-node)](https://startlearning.xpla.io/startlearning/full-node/run-a-full-node/overview/)를 실행할 때에도 xplad를 이용합니다.

xplad에 관한 더 자세한 정보는 [Docs](https://startlearning.xpla.io/startlearning/develop/tools/xplad/install-xplad/)나 [Github](https://github.com/xpladev/xpla)을 참고해보세요.

</Details>

## xplad 설치 {#installxplad}

먼저 xplad를 설치해봅시다. [Docs](https://startlearning.xpla.io/startlearning/develop/tools/xplad/install-xplad/)를 참고하여 설치하셔도 좋습니다.
...
지갑 생성 명령어(`xplad keys add`)에 관한 자세한 정보는 [Docs](https://startlearning.xpla.io/startlearning/develop/tools/xplad/subcommands/#keys-add)를 참고해보세요. 뿐만 아니라 [Docs](https://startlearning.xpla.io/startlearning/develop/tools/xplad/commands/)를 통해 xplad로 실행할 수 있는 다양한 명령어도 확인할 수 있습니다.