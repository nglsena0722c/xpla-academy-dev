...
xplad로 cli에서 트랜잭션을 생성하고, query를 보낼 수도 있습니다. [이전 단계](/startlearning/settings/create-wallet/create-wallet-with-xplad)에서 xplad를 설치하지 않으셨다면, [다음 단계](/startlearning/tutorial/make-cw20/make-cw20-with-vault)로 넘어가셔도 좋습니다. 

## xplad로 트랜잭션 생성하기 {#maketx}

[이전 단계](/startlearning/settings/create-wallet/create-wallet-with-xplad)에서 xplad를 설치하셨고, 지갑도 잘 생성하셨다면 아래 단계를 진행해봅시다. 
...
이렇게 xplad를 활용하여 트랜잭션을 생성해보고, 트랜잭션 데이터도 구해보았습니다. xplad에 관해 더 자세하게 알고 싶다면 [Docs](https://startlearning.xpla.io/startlearning/develop/tools/xplad/about-xplad/)를 참고해보세요.