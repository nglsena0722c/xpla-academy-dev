...
|Learn X in Y minutes|[https://learnxinyminutes.com/startlearning/rust/](https://learnxinyminutes.com/startlearning/rust/)|
|CosmWasm Starter Pack|[https://github.com/CosmWasm/cw-template](https://github.com/CosmWasm/cw-template)|
|XPLA Docs|[https://startlearning.xpla.io/startlearning/develop/smart-contract-guide/wasm/writing-the-contract/](https://startlearning.xpla.io/startlearning/develop/smart-contract-guide/wasm/writing-the-contract/)|
...
지금까지 Cosmwasm 컨트랙트 코드를 분석해보면서, Instantiate, Execute, Query가 어떻게 진행되는지 살펴보았습니다. 예제를 활용하여 여러분만의 Cosmwasm 컨트랙트를 개발해보세요. Cosmwasm 컨트랙트 개발에 관한 다른 예제는 [Docs](https://startlearning.xpla.io/startlearning/develop/smart-contract-guide/wasm/writing-the-contract/)와 [CosmWasm Starter Pack](https://github.com/CosmWasm/cw-template)에도 있습니다.